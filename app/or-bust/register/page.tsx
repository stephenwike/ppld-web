...
export default function RegisterPage() {
    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-12">
            <h1 className="text-4xl font-semibold tracking-tight">Pikes Peak Line Dance …or Bust!</h1>
            <h1 className="text-4xl font-semibold tracking-tight">2026 Registration</h1>
            ...
            <a
                href="/or-bust#mail-in"
                className="inline-flex items-center justify-center rounded-2xl border border-white/25 bg-black/20 my-3 px-4 py-3 text-sm font-medium text-black hover:bg-black/30"
            >
